...
#SOFC_Turbofan.py
# 
# Created:  Feb 2021, Pedro Garcia Gonzalez (TU Delft)
...
from SUAVE.Components.Energy.Converters.Fuel_Cell import SOFC
...
class SOFC_Turbofan(Propulsor):
    ...
    def evaluate_thrust(self,state):
        ...
        combustor.inputs.stagnation_temperature                = high_pressure_compressor.outputs.stagnation_temperature*(1-self.fraction_air_SOFC)+SOFC.outputs.stagnation_temperature*self.fraction_air_SOFC
        combustor.inputs.stagnation_pressure                   = high_pressure_compressor.outputs.stagnation_pressure*(1-self.fraction_air_SOFC)+SOFC.outputs.stagnation_pressure*self.fraction_air_SOFC
